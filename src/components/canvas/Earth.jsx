    ...
    return (
        ...
        <mesh>
            ...
            <primitive // hiển thị mô hình
                object={earth.scene}
                scale={isMobile ? 4.5 : 6} // scale cho mô hình
                position={isMobile ? [0, -2.25, 0] : [0, -1.3, 0]} // điều chỉnh vị trí để mô hình nằm đúng chỗ trong không gian 3D.
...
const EarthsCanvas = () => {
    ...
    return (
        <Canvas
            frameloop='always' // demand -> chỉ update scene khi cần (khi người dùng dịch cam hoặc có j đó thay đổi), always thì ltuc
            shadows
